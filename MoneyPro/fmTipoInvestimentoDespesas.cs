...
namespace MoneyPro
{
    public partial class fmTipoInvestimentoDespesas : MoneyPro.Base.fmBaseFerramentas
    {
        ...
        {
            investimentoDespesaDataGridView.RowValidating -=
                investimentoDespesaDataGridView_RowValidating;
        ...
        private void IncluirInvestimentoDespesa()
        {
            ...
            investimentoDespesaDataGridView.CurrentCell = investimentoDespesaDataGridView.Rows[
                lin
            ].Cells[col];
        }
        ...
        private void CancelarLinhaNova()
        {
            if (investimentoDespesaDataGridView.CurrentRow != null)
            {
                ...
                {
                    investimentoDespesaDataGridView.Rows.Remove(
                        investimentoDespesaDataGridView.CurrentRow
                    );
                }
            }
        }
        ...
        private void investimentoDespesaDataGridView_RowValidating(
            object sender,
            DataGridViewCellCancelEventArgs e
        )
        {
            if (
                investimentoDespesaDataGridView.RowCount > 0
                && investimentoDespesaDataGridView.CurrentRow != null
            )
            {
                if (
                    investimentoDespesaDataGridView.IsCurrentRowDirty
                    || (int)
                        investimentoDespesaDataGridView.CurrentRow.Cells[
                            "InvestimentoDespesaID"
                        ].Value < 0
