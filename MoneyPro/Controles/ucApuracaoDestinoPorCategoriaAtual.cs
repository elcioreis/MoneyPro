...
{
    public partial class ucApuracaoDestinoPorCategoriaAtual : UserControl
    {
        ...
        public ucApuracaoDestinoPorCategoriaAtual()
        {
            InitializeComponent();
            this.Tag = percentual;
            CarregarPainel();
        ...
        private void CarregarPainel()
        {
            ...
            chart.Titles.Clear();
            chart.Titles.Add("Saídas por Categoria - Mês Atual");
