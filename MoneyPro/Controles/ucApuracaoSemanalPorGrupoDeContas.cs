...
{
    public partial class ucVariacaoSemanalGrupoContas : UserControl
    {
        Point? prevPosition = null;
        ToolTip tooltip = new ToolTip();

        public ucVariacaoSemanalGrupoContas(int periodos)
        {
            InitializeComponent();
        ...
        private void CarregarPainel(int periodos)
        {
            ...
            DataTable dados = bll.ApuracaoSemanalPorGrupoDeContas(periodos);
            ...
            chart.Titles.Clear();
            chart.Titles.Add("Variação Semanal dos Grupos de Contas");
