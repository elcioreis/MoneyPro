...
{
    public partial class ucVariacaoSemanalAcumulada : UserControl
    {
        Point? prevPosition = null;
        ToolTip tooltip = new ToolTip();

        public ucVariacaoSemanalAcumulada(int periodos)
        {
            InitializeComponent();
        ...
        private void CarregarPainel(int periodos)
        {
            ...
            DataTable dados = bll.ApuracaoSemanalAcumulada(periodos);
            ...
            chart.Titles.Clear();
            chart.Titles.Add("Variação Semanal Acumulada");
