...
{
    public partial class ucApuracaoDivisaoInvestimento : UserControl
    {
        ...
        public ucApuracaoDivisaoInvestimento()
        {
            InitializeComponent();
            this.Tag = percentual;
            CarregarPainel();
        ...
        private void CarregarPainel()
        {
            ...
            DataTable dados = bll.ApuracaoDivisaoInvestimento();

            chart.DataSource = dados;
            chart.ChartAreas[0].Area3DStyle.Enable3D = true;

            chart.Titles.Clear();
            chart.Titles.Add("Alocação dos Investimentos");
            ...
            chart.Series[conta].XValueMember = "Investimento";
